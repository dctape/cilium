...
var (
	...
	BuildQueueEntries = NoOpGaugeVec
...
func CreateConfiguration(metricsEnabled []string) (Configuration, []prometheus.Collector) {
	...
	for _, metricName := range metricsEnabled {
		...
		case Namespace + "_buildqueue_entries":
			...
			collectors = append(collectors, BuildQueueEntries)
			c.BuildQueueEntriesEnabled = true
